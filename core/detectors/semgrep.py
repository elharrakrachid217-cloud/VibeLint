...
against a temp file and converts JSON findings into VibeGuard's
...
class SemgrepDetector(BaseDetector):
    """Wraps Semgrep CE as a VibeGuard detector for data-flow analysis."""

    _warned_missing = False

    def __init__(self, ruleset: str = _DEFAULT_RULESET):
    ...
    def _parse_output(raw_json: str, code: str) -> list[dict]:
        """Convert semgrep JSON output into VibeGuard violations."""
        try:
